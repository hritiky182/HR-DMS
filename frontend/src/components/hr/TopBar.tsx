...
import { Search, Bell, Upload, X, FileText, User as UserIcon, Menu, FileStack } from "lucide-react";
...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center border-b bg-background w-full">
      <div className="mx-auto flex w-full max-w-7xl items-center px-6 justify-between gap-3">
        {/* Mobile Menu trigger */}
        <Button
          variant="ghost"
          size="icon"
          className="md:hidden shrink-0 -ml-2 mr-1"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden bg-background/80 backdrop-blur-sm">
          <div className="fixed inset-y-0 left-0 w-60 bg-sidebar border-r flex flex-col p-4 shadow-xl animate-in slide-in-from-left duration-200">
            <div className="flex h-10 items-center justify-between border-b pb-2 mb-4">
              <div className="flex items-center gap-2">
                <div className="flex size-7 items-center justify-center rounded-md bg-primary text-primary-foreground">
                  <FileStack className="size-4" />
                </div>
                <span className="text-sm font-semibold">HR-DMS</span>
              </div>
              <Button
                variant="ghost"
                size="icon"
